class Car{
    ...
    update(roadBorders,traffic){
        if(!this.damaged){ //If the car is damaged it stops moving
            this.#move();
        ...
        if(this.sensor){
            ...
            ); //if null (sensor sees nothing) 0, else return 1 - offset px 
    ...
    #createPolygon(){
        ...
        //Get the corner points of the car and push to points
        points.push({
